...
def add_base_capacitor():
    ...
    (property "Reference" "C" (at 2.54 2.54 0)
    ...
    (property "Voltage" "" (at 2.54 -2.54 0)
    ...
    (symbol "C_1_1"
      (pin passive line (at 0 5.08 270) (length 4.064)
        (name "~" (effects (font (size 1.27 1.27))))
        (number "1" (effects (font (size 1.27 1.27))))
      )
      (pin passive line (at 0 -5.08 90) (length 4.064)
        (name "~" (effects (font (size 1.27 1.27))))
...
def add_capacitor(
  ...
  (symbol "{manufacturer} {mpn}" (extends "C")
    ...
    (property "Voltage" "{voltage}" (at 2.54 -2.54 0)
      (effects (font (size 1.27 1.27) (color 0 100 100 1)) (justify left))
    )
